...
tf.app.flags.DEFINE_integer("n_attack", 1000,
                            "attacked example number")
tf.app.flags.DEFINE_string("data_path", "../attack_data/b_attack_1k.pkl",
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(0,1000):
            ...
            if ind_logits == (ind+1)%10:
                cnt = cnt + 1
                x_succ.append(x)
                x_old.append(correct_image[i].reshape((1, 28, 28, 1)))
                labels.append(ind)
